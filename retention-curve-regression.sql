...
WITH data AS (
    SELECT *
    -- Change this to pull data directly from your database, datalake, etc
...
-- If you want to plot the curve, you can use the following code
-- SELECT age, a2 + b2*EXP(c2*age) as revenue
-- FROM UNNEST(GENERATE_ARRAY(0, ({{snippet: Lifetime forced max value}}))) AS age, coefficients