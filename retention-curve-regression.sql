-- Using 12-month data from https://demo.profitwell.com/app/trends/cohorts and with minor adjustments to m9+ data for educational purposes
-- When using your data, make sure to summarize it just 3 columns: cohort, age, revenue (as percent of age 0 revenue)
-- Adapted algorithm from page 17 of https://www.scribd.com/doc/14674814/Regressions-et-equations-integrales to with with SQL
...
SELECT CONCAT(a2, ' + ', b2, '*exp(', c2, '*age)') as curve, r_squared
